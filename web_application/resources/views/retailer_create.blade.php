    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
        <div class="card">
            <div class="card-header"> <i class="fa fa-store"></i>
                THÊM NHÀ PHÂN PHỐI - BÁN LẺ
                <a href="{{route('retailer_index')}}" class="btn btn-info float-right"> <strong> <i class="fa fa-undo"></i> DANH SÁCH NHÀ PHÂN PHỐI - BÁN LẺ </strong> </a>
            </div>

            <div class="card-body">

				<div class="col-xs-12 col-sm-12 col-md-10 col-lg-8 col-xl-6 offset-md-1 offset-lg-2 offset-xl-3">
					<form action="{{route('retailer_store')}}" method="POST">
						@csrf
						...
						<div class="form-group row">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" id="companyname" name="companyname" placeholder="Tên nhà vận phân phối - bán lẻ">
