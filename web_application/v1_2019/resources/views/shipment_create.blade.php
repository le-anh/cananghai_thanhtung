                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                            ...
                            <nav>
                                <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                                    <a class="nav-item nav-link active" id="nav-distributor-tab" data-toggle="tab" href="#nav-distributor" role="tab" aria-controls="nav-distributor" aria-selected="true">Chuyển</a>
                                    <a class="nav-item nav-link" id="nav-retailer-tab" data-toggle="tab" href="#nav-retailer" role="tab" aria-controls="nav-retailer" aria-selected="true">Phân phối</a>
                            ...
                            <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                                <div class="tab-pane fade show active" id="nav-distributor" role="tabpanel" aria-labelledby="nav-distributor-tab" width="100%">
                                    <div class="text-center">
                                        <h4> Ai chuyển hàng? </h4>
                                        <div class="col-xs-12 col-sm-10 col-md-10 col-lg-8 col-xl-8 offset-sm-1 offset-md-1 offset-lg-2 offset-xl-2">
                                            <select name="distributor" id="distributor" class="custom-select form-control">
                                                <option value=""> --- Chọn đơn vị chuyển hàng --- </option>
                                                @if(isset($distributorList))
                                                    @foreach($distributorList as $key => $distributor)
                                                        <option value="{{$distributor->tradeId}}"> {{$distributor->companyName}} </option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        </div>
                                        <div id="text_alert_distributor" class="text-danger"></div>
                                    </div>
                                ...
                                <div class="tab-pane fade show " id="nav-retailer" role="tabpanel" aria-labelledby="nav-retailer-tab" width="100%">
                                    <div class="text-center">
                                        <h4> Chuyển cho ai? </h4>
                                        <div class="col-xs-12 col-sm-10 col-md-10 col-lg-8 col-xl-8 offset-sm-1 offset-md-1 offset-lg-2 offset-xl-2">
                                            <select name="retailer" id="retailer" class="custom-select form-control">
                                                <option value=""> --- Chọn đơn vị nhận hàng --- </option>
                                                @if(isset($retailerList))
                                                    @foreach($retailerList as $key => $retailer)
                                                        <option value="{{$retailer->tradeId}}"> {{$retailer->companyName}} </option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        </div>
                                        <div id="text_alert_retailer" class="text-danger"></div>
                                    </div>
